...
class FirebaseMethods {
  ...
  Reference fibaseStorage = FirebaseStorage.instance.ref();
  ...
  Future<void> addMessageToDb(
    ...
    try {
      ...
      String errMessage = 'An error occured while uploading the image...';
  ...
  Future<void> uploadImage({
    ...
    try {
      Reference _storageRef = fibaseStorage.child(
  ...
  Future<void> uploadProfilePic({
    ...
    try {
      Reference _storageRef = fibaseStorage.child('profilePic/$uid');
      await _storageRef.putFile(image);
      String imageUrl = await _storageRef.getDownloadURL();
