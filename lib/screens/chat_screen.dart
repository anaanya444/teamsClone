...
import 'package:skype_clone/extras/permissions.dart';
import 'package:skype_clone/resources/call_methods.dart';
import 'package:skype_clone/resources/firebase_methods.dart';
import 'package:skype_clone/screens/call_screens/pickup_layout.dart';
...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({@required this.reciever});
  @override
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget messageBubble(QueryDocumentSnapshot snapshot) {
    bool _isTextMessage = snapshot.data() == 'text';
